...
@register_middle
class SpMiddleFHDMegvii(nn.Module):
    def __init__(self,
                 output_shape,
                 use_norm=True,
                 num_input_features=128,
        ...
        # Peiyun: Disable use_hash 
        SpConv3d = change_default_args(use_hash=False)(spconv.SparseConv3d)
        SubMConv3d = change_default_args(use_hash=False)(spconv.SubMConv3d)
        #
        sparse_shape = np.array(output_shape[1:4]) + [1, 0, 0]
        # sparse_shape[0] = 11
