...
def build(model_cfg: second_pb2.VoxelNet, voxel_generator,
    ...
    num_input_features = model_cfg.voxel_feature_extractor.num_input_features
    ...
    net = get_voxelnet_class(model_cfg.network_class_name)(
        ...
        rpn_num_groups=model_cfg.rpn.num_groups,
        rpn_use_groupnorm=model_cfg.rpn.use_groupnorm,
        vpn_class_name=model_cfg.vpn.module_class_name,
        vpn_num_input_features=model_cfg.vpn.num_input_features,
        vpn_layer_nums=list(model_cfg.vpn.layer_nums),
        vpn_layer_strides=list(model_cfg.vpn.layer_strides),
        vpn_num_filters=list(model_cfg.vpn.num_filters),
        vpn_upsample_strides=list(model_cfg.vpn.upsample_strides),
        vpn_num_upsample_filters=list(model_cfg.vpn.num_upsample_filters),
        vpn_num_groups=model_cfg.vpn.num_groups,
        vpn_use_groupnorm=model_cfg.vpn.use_groupnorm,
        use_norm=True,
